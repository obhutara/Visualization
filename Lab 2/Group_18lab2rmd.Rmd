...
ggplot(ol, aes(palmitic, oleic)) + geom_point() + 
    geom_spoke(angle = ol$disc, radius = 40)+ggtitle("Scatter plot of palmitic vs oleic discretized by linolenic
                    Orientation angle of spoke is 4 classes of Linolenic")
```
